...
class TextCleaner:
    ...
    Attributes:
        ...
        ui_text_patterns (List[str]): Patterns for identifying UI-related text
    ...
    Methods:
        ...
        is_substantial_text: Checks if text is meaningful enough for processing
    """
    ...
    def normalize_text(self, text: str) -> str:
        ...
        text = re.sub(r'[•|]', ' ', text)  # Add pipe to special chars
...
class HTMLProcessor:
    ...
    Methods:
        ...
        _remove_unwanted_elements: Filters non-content HTML elements
        _should_keep_element: Determines if an HTML element contains content
