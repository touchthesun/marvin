...
prompt = PromptTemplate(
    ...
    Use the vectorstore for questions on LLM  agents, AI safety, LLM Jailbreaking, and Language Model research. \n
...
# Run
inputs = {"question": "What methods can detect or protect against sleeper agent language models?"}
